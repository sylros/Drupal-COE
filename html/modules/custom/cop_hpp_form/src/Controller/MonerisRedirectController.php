...
namespace Drupal\cop_hpp_form\Controller;
 ...
 */
class MonerisRedirectController implements ContainerInjectionInterface {
  ...
  public function post() {
    ...
    \Drupal::logger('cop_hpp_form')->info('The post function got called');
  ...
  public function on302() {
    ...
    \Drupal::logger('cop_hpp_form')->info('The 302 function got called');
